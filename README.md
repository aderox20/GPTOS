...
GPTOS is a minimal Linux-based operating system built from scratch. You can either **build it from source** using the provided script or **download the pre-built ISO** directly from this repository.
